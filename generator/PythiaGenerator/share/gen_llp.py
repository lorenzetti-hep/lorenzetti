#!/usr/bin/env python3
from GaugiKernel.messenger    import LoggingLevel, Logger
...
parser.add_argument('-s','--seed1', action='store', dest='seed', required = False, type=int, default=0,
                    help = "The pythia seed (zero is the clock system)")

parser.add_argument('-s2','--seed2', action='store', dest='seed2', required = False, type=int, default=0,
                    help = "The pythia seed (zero is the clock system)")
...
main_file = os.environ['LZT_PATH']+'/generator/PythiaGenerator/data/llp_config.cmnd'
...
from PythiaGenerator import LLPGun
