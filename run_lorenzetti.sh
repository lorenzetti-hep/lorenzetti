...
NOV=100 && \ls
seed=3973534 && \
base_dir="/sps/atlas/l/lboggia/test_lorenzetti/lorenzetti/2025_05_08_50_jets" && \
...
# (gen_jets.py --output-file jets.EVT.root --nov $NOV --pileup-avg 0 --seed $seed -nt $n_workers --events-per-job 50 |& tee "${base_dir}/jets.EVT.log") && \
...
# (digit_trf.py -i $hit_dir -o "jets.ESD.root" -nt $n_workers -m |& tee "${base_dir}/jets_wanomalies.ESD.log") && \
